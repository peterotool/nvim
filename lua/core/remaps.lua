...
vim.keymap.set('n', '<leader>q', '<cmd>bdelete!<CR>', { desc = '[C]lose Buffer' }) -- close buffer
...
-- vim.keymap.set('n', '<C-M-Up>', '<Plug>(VM-Select-Cursor-Up)')
-- vim.keymap.set('n', '<C-M-Down>', '<Plug>(VM-Select-Cursor-Down)') -- M(Option key) + D(Command key)
