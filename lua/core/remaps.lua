...
-- vim.keymap.set('n', '<leader>tt', ':ToggleTerm size=20 direction=vertical<CR>', { noremap = true })
-- vim.keymap.set('n', '<leader>tf', ":ToggleTerm direction=float name='Will it work?'<CR>", { desc = 'Floating term' })
...
vim.keymap.set('n', '<leader>q', '<cmd>bd<CR>', { desc = '[C]lose Buffer' }) -- close buffer
vim.keymap.set('n', '<leader>b', '<cmd> enew <CR>', { desc = '[N]ew Buffer' }) -- new buffer

-- Window management
vim.keymap.set('n', '<leader>v', '<C-w>v', { desc = '[S]plit Window [V]ertically' }) -- split window vertically
-- vim.keymap.set('n', '<leader>h', '<C-w>s', { desc = '[S]plit Window [H]orizontally' }) -- split window horizontally
...
-- sniprun
vim.keymap.set('v', '<leader>rs', '<Plug>SnipRun', { desc = '[R]un [S]nip' })
vim.keymap.set('n', '<leader>rs', '<Plug>SnipRun', { desc = '[R]un [S]nip' })
vim.keymap.set('n', '<leader>rs', '<Plug>SnipRunOperator', { desc = '[R]un [S]nip' })
...
vim.keymap.set('i', '<S-^><Space>', '^', { noremap = true, silent = true })
